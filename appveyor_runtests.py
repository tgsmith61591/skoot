...
Examples::
    ...
    $ python appveyor_runtests.py
    $ python appveyor_runtests.py -s {SAMPLE_SUBMODULE}
    $ python appveyor_runtests.py -t {SAMPLE_TEST}
    $ python appveyor_runtests.py --ipython
    $ python appveyor_runtests.py --python somescript.py
    $ python appveyor_runtests.py --bench

Run a debugger:

    $ gdb --args python appveyor_runtests.py [...other args...]

Generate C code coverage listing under build/lcov/:
(requires http://ltp.sourceforge.net/coverage/lcov.php)

    $ python appveyor_runtests.py --gcov [...other args...]
    $ python appveyor_runtests.py --lcov-html

This is adapted from the scipy appveyor_runtests.py file.
"""
...
PROJECT_MODULE = "skoot"
PROJECT_ROOT_FILES = [PROJECT_MODULE, 'LICENSE.txt', 'setup.py']
SAMPLE_TEST = "skoot.decomposition.tests.test_decompose::test_selective_pca"
SAMPLE_SUBMODULE = "decomposition"
...
# should happen PRE-import (otherwise the other namespaces are in global env)
if __doc__ is None:
...
def build_project(args):
    ...
    if not all(root_ok):
        print("To build the project, run appveyor_runtests.py in "
            ...
            while p.poll() is None:
                ...
                if time.time() - last_blip > 60:
                    ...
                    if log_size > last_log_size:
                        ...
                        print("    ... build in progress ({0} elapsed)"
                              .format(elapsed))
