...
# Local submodule funcs that use Fortran subroutines. Absolute import seems to
# be more stable?
from skoot.decomposition._dqrutl import \
    qr_decomposition, _call_dqrcf, _validate_matrix_size, _qr_R
